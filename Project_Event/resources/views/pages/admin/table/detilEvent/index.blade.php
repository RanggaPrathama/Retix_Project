                            ...
                            <div class="col-12">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <a href="{{ route('detilevent.create') }}"><button type="button"
                                            ...
                                            <tbody>
                                                @foreach ($detilEvents as $detilEvent)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            @if ($detilEvent->status == 0)
                                                                <p>Non Aktif </p>
                                                            @elseif ($detilEvent->status == 1)
                                                                <p>Aktif</p>
                                                            @else
                                                                <p>Coming Soon</p>
                                                            @endif
                                                        ...
                                                        <td>
                                                            <a
                                                                href="{{ route('detilevent.edit', $detilEvent->id_detilEvent) }}"><button
                                                                    type='submit'class="btn btn-success"><i
                                                                        class="bi bi-pencil-square"></i></button></a>
                                                            <form
                                                                action="{{ route('detilevent.destroy', $detilEvent->id_detilEvent) }}"
