    ...
    @section('content')
                ...
                <div class="card col-lg-3 mx-4" style="margin-top: -30px;">
                    ...
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item">
                            <img class="text-center" src="{{ asset('gambarEvent/' . $detilEvent->gambar_event) }}"
                                alt="" width="200" height="125">
                        </li>
                        <li class="list-group-item">
        ...
        @endif --}}
                            ...
                            <li class="list-group-item ">
                                <table class="table table-borderless">
                                    ...
                                    <tr>
                                        <td>Buy At</td>
                                        <td>:</td>
                                        <td>{{ \Carbon\Carbon::parse($purchase->tgl_pembayaran)->translatedFormat('l, d F Y | H:i') }}
                                        </td>
                                    </tr>
                                    <tr>
            ...
            <div class="row">
                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        @foreach ($ticketDetail as $tiket)
                            <li class="list-group-item ">
                                <table class="table table-borderless">
                                    <tr>
                                        <td>Tiket {{ $tiket->nama_kategori }} <br>
                                            {{ 'RP ' . number_format($tiket->harga_event, '0', ',', '.') }} x
                                            {{ $tiket->quantity }}</td>
                                        <td style="text-align: right;" scope="col">
                                            {{ 'Rp. ' . number_format($tiket->SUBTOTAL, '0', ',', '.') }}</td>
                                    </tr>
                                </table>
                            </li>
                        @endforeach
                ...
                <button class="btn btn-success mb-5 " id="buttonpdf"> Download PDF </button>
            </div>
            <br>
        </div>
        ...
        <script>
            ...
            //                 pdf.addImage(image,'PNG',15,15,1110,381);
            //                 pdf.save('buktibayar.pdf');
            ...
            document.getElementById('buttonpdf').addEventListener('click', function() {
                html2canvas(document.getElementById('content')).then(canvas => {
                    ...
                    let pdf = new jsPDF('p', 'px', [1200, 1131]);
                    pdf.addImage(base64image, 'PNG', 15, 15, 1110, 600);
                    pdf.save('buktibayar.pdf');
                });
            });
        </script>
